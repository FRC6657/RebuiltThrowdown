...
import frc.robot.GlobalConstants.CAN;
  ...
  public static final class DriveConstants {
    ...
    public static final SwerveModuleInformation kFrontLeftSwerveModule =
        new SwerveModuleInformation(
            "Front Left", CAN.Swerve_FL_D.id, CAN.Swerve_FL_T.id, new Rotation2d(Math.PI / 2));
    public static final SwerveModuleInformation kBackLeftSwerveModule =
        new SwerveModuleInformation(
            "Back Left", CAN.Swerve_BL_D.id, CAN.Swerve_BL_T.id, new Rotation2d(Math.PI));
    public static final SwerveModuleInformation kFrontRightSwerveModule =
        new SwerveModuleInformation(
            "Front Right", CAN.Swerve_FR_D.id, CAN.Swerve_FR_T.id, new Rotation2d(0));
    public static final SwerveModuleInformation kBackRightSwerveModule =
        new SwerveModuleInformation(
            "Back Right", CAN.Swerve_BR_D.id, CAN.Swerve_BR_T.id, new Rotation2d(-Math.PI / 2));
